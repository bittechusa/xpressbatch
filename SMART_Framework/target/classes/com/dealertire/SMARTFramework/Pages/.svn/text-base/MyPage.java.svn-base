...
public class MyPage extends SMARTPage {
	 ...
	 */
	public DealerPage clickDealerNameInSearchResults(String dealerID) {
		WebElement nameElement = dealerList.findElement(By.cssSelector("div.row[data-dealershipid='" + dealerID + "'] address a"));
		nameElement.click();
